...
class ProfilePicForm(forms.ModelForm):
      ...
      homepage_link = forms.CharField(label="Homepage", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Homepage'}),required=False)
      facebook_link = forms.CharField(label="Facebook", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Facebook'}),required=False)
      instagram_link = forms.CharField(label="Instagram", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Instagram'}),required=False)
      linkedin_link = forms.CharField(label="LinkedIn", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'LinkedIn'}),required=False)
      class Meta:
            model = Profile 
